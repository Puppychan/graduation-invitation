...
Creative Commons public licenses provide a standard set of terms and conditions that creators and the public may use. The following considerations for the public also apply to creators and the public should follow them in order to make use of the licensed material.
...
For the full license text, visit: https://creativecommons.org/licenses/by-nc/4.0/legalcode.en